...
bool UI::validateSelection(std::string selection,
...
std::string UI::retrieveInput(std::string selectionOptions[],
							  int numOptions) {
	// show user the allowed options
	std::cout << "\nPlease enter your selection. You can choose between: ";
...
std::string UI::retrieveSelection(std::string selectionOptions[], int numOptions) {
...
int UI::retrieveSelectionIndex(std::string selectionOptions[], int numOptions) {
	...
	std::cout << "ERROR • UI::retrieveUserSelection - "
			  << "THIS SHOULD NEVER HAPPEN" << std::endl;
	throw "ERROR • UI::retrieveUserSelection";
	return -1;
}
